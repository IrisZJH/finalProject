    ...
    <c:if test="${not empty sessionScope.salaryList}">
        <c:forEach items="${sessionScope.salaryList}" var="salary">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/dissent.jsp">异议</a></td>
            </tr>
        </c:forEach>
    </c:if>
    <tr>

        <td colspan="9" align="center"><a href="${pageContext.request.contextPath}/employeepage.jsp"><input type="button" value="返回"></a></td>
        <td>${Dss}</td>
    </tr>
</table>
